...
public partial class administrativo_Listaativos2 : System.Web.UI.Page
{
    ...
    protected void grdMain_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("editRecord"))
        {
            ...
            Response.Redirect("~/administrativo/DetalhesPacienteTentativa2.aspx?prontuario=" + _prontuario);
        }
    }
}
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DetalhesPacienteTentativa2.aspx.cs" Inherits="administrativo_DetalhesPacienteTentativa2" Title="Call HSPM" %>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <asp:Label ID="txbIDAtivo" Visible="false" runat="server" Text=""></asp:Label>
                                            </div>
                                        </div>
                                        <div class="form-group row">

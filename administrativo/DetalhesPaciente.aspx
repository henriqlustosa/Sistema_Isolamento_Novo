<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DetalhesPaciente.aspx.cs" Inherits="administrativo_DetalhesPaciente"
    Title="Call HSPM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div class="x_content">
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Data_Contato" HeaderText="Data do Contato" SortExpression="Data_Contato"
                            ItemStyle-CssClass="hidden-xs" HeaderStyle-CssClass="hidden-xs" />
                                ...
                                <div class="container">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control col-4" DataSourceID="SqlDataSource1"
        ...
        <hr />
        <div class="x_content">
            <asp:Button ID="btnVoltar" runat="server" Text="Lista 1ª Tentativa" class="btn btn-primary"
                OnClick="btnVoltar1_Click" />
        </div>
         </ContentTemplate>
        </asp:UpdatePanel>
    </div>

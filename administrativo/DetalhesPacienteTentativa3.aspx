<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DetalhesPacienteTentativa3.aspx.cs" Inherits="administrativo_DetalhesPacienteTentativa3" Title="Call HSPM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="x_content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                ...
                                                SelectCommand="SELECT [id_status], [status] FROM [status_consulta]">
                                            </asp:SqlDataSource>
                                        </div>
                                    </div>
                                </div>
        ...
        <hr />
        <div class="x_content">
            <asp:Button ID="Button2" runat="server" Text="Lista 3ª Tentativa" class="btn btn-danger" onclick="btnVoltar2_Click" />
        </div>
    </div>
    <!-- /page content -->
</asp:Content>
